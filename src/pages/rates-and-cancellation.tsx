...
const RatesAndCancellations = () => {
  return (
    <>
      <PageHead
        title="Rates & Cancellations - John Dempster Mediation"
          ...
          <div className="w-full max-w-[1000px] flex flex-col gap-10">
            <div className="flex flex-col gap-4 items-center">
              ...
              <p className="text-center text-slate-600 text-xs">
                *Additional time beyond the scheduled mediation will be charged
                at $400.00 per hour plus HST.
              </p>
            </div>
...
export default RatesAndCancellations;
